  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-white">熱點列表</h1>
          <p className="text-gray-500 text-sm mt-0.5">全平台熱點總覽</p>
        </div>
      ...
      <div className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden">
        {loading ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 text-sm">找不到熱點</p>
          </div>
        ) : (
          <>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-800 bg-gray-900/60">
                    <th className="text-left px-5 py-3 text-gray-500 font-medium">熱點名稱</th>
                    ...
                    <th className="text-right px-5 py-3 text-gray-500 font-medium">連線（30天）</th>
                    <th className="text-right px-5 py-3 text-gray-500 font-medium">收入（30天）</th>
            ...
            <div className="flex items-center justify-between px-5 py-3 border-t border-gray-800">
              <p className="text-xs text-gray-500">第 {page} 頁 · {hotspots.length} 筆結果</p>
